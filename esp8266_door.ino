...
int get_http(String state)
{
   ...
   //http.begin("http://maker.ifttt.com/trigger/door/with/key/l6-UVR3nScQP9NKP4C90ZyEzaXAeXoVl085gYR37_er"); //HTTP
   //If you have enabled value1 from iftt settings then uncomment below line to send value and comment out above line  
   http.begin("http://maker.ifttt.com/trigger/door/with/key/l6-UVR3nScQP9NKP4C90ZyEzaXAeXoVl085gYR37_er/?value1="+state); //HTTP

    Serial.print("[HTTP] GET...\n");
    // start connection and send HTTP header
    //int httpCode = http.POST("{\"value1\" : \"GOT IT\"}");
